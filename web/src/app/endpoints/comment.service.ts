...
export class CommentService {
  ...
  addComment(searchQuery: string, searchType: string, commentText: string, parentId?: number): Observable<any> {
  ...
  getComments(searchQuery: string, searchType: string, limit: number = 100): Observable<{ comments: Comment[] }> {
